...
package pe.com.grupopalomino.agachadito.Utils.spacetablayout;
...
public class SpaceTabLayout extends RelativeLayout {
    ...
    private void init() {
        ...
        defaultTabOneButtonIcon = getContext().getResources().getDrawable(R.drawable.menu_hamburguesa);
        defaultTabTwoButtonIcon = getContext().getResources().getDrawable(R.drawable.menu_map);
        defaultTabThreeButtonIcon = getContext().getResources().getDrawable(R.drawable.menu_home);
        defaultTabFourButtonIcon = getContext().getResources().getDrawable(R.drawable.menu_visa);
        defaultTabFiveButtonIcon = getContext().getResources().getDrawable(R.drawable.menu_perfil);

        defaultTextColor = ContextCompat.getColor(getContext(), android.R.color.white);
